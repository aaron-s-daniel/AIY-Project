...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-157570 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-157570 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-157570 --data-directory data --out-directory out
    ```
...
3. Set 'Docker container' to `custom-block-157570`.
